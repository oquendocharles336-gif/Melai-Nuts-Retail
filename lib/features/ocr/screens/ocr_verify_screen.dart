...
class OcrVerifyScreen extends StatefulWidget {
  ...
  OcrVerifyScreen({super.key, OcrScanResult? result}) : result = result ?? OcrScanResult.simulatedSample();
        ...
        child: ListView(
          ...
          children: [
            ...
            _FieldCard(
              ...
              label: 'Product Name',
              trailing: 'Matched SKU: ${widget.result.matchedSku}',
            ...
            _FieldCard(
              ...
              label: 'Batch Number',
              trailing: 'Format OK',
              child: TextField(controller: _batchController),
            ),
            _FieldCard(
              number: 3,
            ...
            _FieldCard(
              ...
              child: TextField(controller: _staffController),
            ),
            const SizedBox(height: AppSpacing.md),
            PrimaryButton(
