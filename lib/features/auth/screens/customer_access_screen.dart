...
class _CustomerAccessScreenState extends State<CustomerAccessScreen> {
  bool _isSignIn = true;
  final _nameController = TextEditingController(text: 'Elena Bautista');
  final _phoneController = TextEditingController(text: '+63 917 555 3821');
  final _emailController = TextEditingController(
    text: 'customer@melainuts.com',
  );
  ...
  Future<void> _continue() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Simulated sign-in as Customer')),
    );
    Navigator.of(
      context,
