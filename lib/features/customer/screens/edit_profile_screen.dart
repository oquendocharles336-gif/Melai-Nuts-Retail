...
class _EditProfileScreenState extends State<EditProfileScreen> {
  final _nameController = TextEditingController(text: 'Elena Dimaculangan');
  final _emailController = TextEditingController(text: 'elena.dimaculangan@gmail.com');
  final _phoneController = TextEditingController(text: '+63 917 536 1288');
  final _addressController = TextEditingController(
    text: 'Unit 4B, Lakeside Residences, Calamba, Laguna',
  );
  bool _saving = false;
